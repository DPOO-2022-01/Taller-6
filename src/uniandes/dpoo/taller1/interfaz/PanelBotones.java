...
public class PanelBotones extends JPanel implements ActionListener
{
	...
	public PanelBotones(InterfazLibreria interfazLibreria)
	{
		...
		agregarBoton(CATEGORIA_MAS_LIBROS, "Buscar la categor�a con m�s libros", "./data/iconos/libreria.png");
		agregarBoton(CONTAR_SIN_PORTADA, "Contar libros sin portada", "./data/iconos/libro.png");
		agregarBoton(CATEGORIA_MEJOR, "Buscar la mejor categor�a", "./data/iconos/premio.png");
		agregarBoton(AUTOR_VARIAS_CATEGORIAS, "Buscar autor con m�s categor�as", "./data/iconos/autor.png");
